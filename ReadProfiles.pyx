...
cdef class ReadProfiles:
    ...
    cpdef initialize(self):
        ...
        self.ref_grp = self.root_grp.groups['reference']
        self.ts_grp = self.root_grp.groups['timeseries']
        # self.root_grp.close()

        #Fixed profiles for PRP
        self.albedo_grp = nc.Dataset(self.path_plus_file_albedo, 'r')
        self.profile_grp2 = self.albedo_grp.groups['profiles']
        self.ref_grp2 = self.albedo_grp.groups['reference']
        self.ts_grp2 = self.albedo_grp.groups['timeseries']
