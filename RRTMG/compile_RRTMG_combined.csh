...
gfortran-mp-8 -ffixed-line-length-none -freal-4-real-8 -fno-range-check -fPIC \
  ...
  ${CPATH_LW}/mcica_random_numbers.f90 ${CPATH_LW}/mcica_subcol_gen_lw.f90 \
  ...
  ${CPATH_LW}/rrtmg_lw_rad.f90 ${BPATH}/rrtmg_lw_wrapper.f90
...
gfortran-mp-8 -ffixed-line-length-none -freal-4-real-8 -fno-range-check -fPIC \
  ...
  ${CPATH_SW}/mcica_random_numbers.f90 ${CPATH_SW}/mcica_subcol_gen_sw.f90 \
  ...
  ${CPATH_SW}/rrtmg_sw_rad.f90 ${BPATH}/rrtmg_sw_wrapper.f90
...
ld -r parkind.o \
  ...
  rrlw_wvn.o \
  mcica_random_numbers.o mcica_subcol_gen_lw.o mcica_subcol_gen_sw.o \
  ...
  rrtmg_lw_rad.o rrtmg_lw_wrapper.o\
  rrtmg_sw_rad.o rrtmg_sw_wrapper.o \
  -o ../rrtmg_combined.o
